...
def main(copy2tmp_path_list=None, save_result=True):
    # 0. copy宏文件到tmp目录
    copy_file(DAILY_REPORT_SOURCE_TEMPLATE_PATH, DAILY_REPORT_TEMPLATE_PATH)
    ...
    text = num_text + leader_word_template_text.format(**leader_word_variables)
    if save_result:
