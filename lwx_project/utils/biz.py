...
from lwx_project.scene.const import EXCEL_TOOL_PATH
...
def sheet_capture2(excel_path, sheet_name_or_index, img_path, padding=None, run_mute=False):
    """
    ...
    macro_with_args = {
        f"{file_name}!{MACRO_NAME}": [excel_path, sheet_name_or_index, img_path, *padding]
    }
